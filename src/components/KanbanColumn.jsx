    ...
    >
      ...
      <div className={`${column.color} rounded-lg p-3 sm:p-4 mb-2 sm:mb-4`}>
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-base sm:text-lg text-gray-900">{column.title}</h3>
      ...
      {/* Tasks Container */}
      <div 
        className="flex-1 space-y-2 sm:space-y-3 overflow-y-auto p-2 hover:bg-gray-50 rounded-lg transition-colors"
        role="list"
        aria-label={`${column.title} tasks`}
      >
        {tasks.length === 0 ? (
          <div className="text-center py-6 sm:py-8 text-gray-600" role="status" aria-live="polite">
